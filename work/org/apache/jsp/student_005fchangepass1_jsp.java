...
public final class student_005fchangepass1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                  ");
                  ...
                  String newpass1=request.getParameter("t3");
                  String check="";
                  bean b1=new bean();
                  b1.setUsername(username);
                  b1.passcheck();
                  check=b1.getPassword();
                  ...
                  if(oldpass.equals(check))
                  {
                  	...
                  	{
                  		out.print("you didnot enter the new password same in both fields");
                  		out.print("<a href='student_changepass.jsp'>Try Again</a>");
                        
                  	}
                  }
                  else
                  {
                	  out.print("you didnot enter your password correct");
                	  out.print("<a href='student_changepass.jsp'>Try Again</a>");
                  }

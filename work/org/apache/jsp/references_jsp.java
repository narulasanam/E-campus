...
public final class references_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    <FORM  name=f1 METHOD=POST ENCTYPE=multipart/form-data  ACTION=\"references1.jsp\">\r\n");
      out.write("                    <tr>\r\n");
      ...
      out.write("                    \r\n");
      out.write("                    <tr>\r\n");
      out.write("                      <td width=\"130\" align=\"center\"> Attach file.......... </td>\r\n");
      ...
      out.write("\t\t\t\t ");
				...
				bean b3=new bean();
				String cimage="";
				ArrayList a=b3.showattachments();
				...
				{
					 bean b2=(bean)t.next();
					String atowner=b2.getAtowner();
					bean b4=new bean();
					
					b4.setImgusername(atowner);
					if(atowner.equals("admin"))
      ...
      out.write("\t<tr>\r\n");
      out.write("\t\r\n");
      out.write("\t<td width=\"85%\" align=\"center\"><a href=\"references/");
      out.print(b2.getAttachment() );
      out.write('"');
      out.write('>');
      out.print(b2.getAttachment() );
      out.write("</a></td>\r\n");

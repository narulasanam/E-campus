...
public final class create_005falbum1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <td align=\"center\" bgcolor=\"#FFFFFF\"><a href=\"#\" class=\"centerlinks\">References</a></td>\r\n");
      ...
      out.write("                  ");
                  ...
                  if((albumname.equals("")))
                  {
                	  out.print("Name of the album should be defined");
                  }
                  else
                  {
                	
                	b1.setUsername(username);
            	  	b1.setAlbumname(albumname);
            	  
            	  	if((b1.album_namecheck()))
            	  	{
            			 out.print("Name already exist"); 
              	    }
            	  else
            	 	 {
            	  b1.setDescription(description);
					...
					out.print("Album Created");
					
      out.write("\r\n");
      out.write("\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t<a class=\"elink\" href='albums.jsp'>Add Photos To Album</a>\r\n");
      out.write("            \t  \t\r\n");
      out.write("            \t  \t");
}

...
public final class profile_005fother_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                  ");
                  ...
                  if(type.equals("1"))
                  {	
                	response.sendRedirect("profile_other_t.jsp?nam="+name);
                  }
                	
                	else
                	response.sendRedirect("profile_other_s.jsp?nam="+name);

...
function fo()
{
if(document.f1.albumname.value=="")
{
            ...
            <%@ include file="adminmiddlemenu.jsp" %>
              ...
              <table width="100%" height="591" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <form name="f1" action="create_album1.jsp">
                  <table width="478" height="132" border="1" cellpadding="0" cellspacing="0">
                    <tr>
                      <td height="45" align="center">Album Name </td>
                      <td align="center"><input type="text" name="albumname"></td>
                    </tr>
                    <tr>
                      <td height="85" align="center">Description</td>
                      <td align="center"><textarea name="description"></textarea></td>
                    </tr>
                  </table>
                    <table width="200" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="33" align="center"><input type="button" value="Create" onclick="fo()"></td>
                      </tr>
                    </table>
                  </form>

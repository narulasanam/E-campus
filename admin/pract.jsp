  ...
  <tr bgcolor="#2B1521">
    <td height="617" valign="top"><table width="100%" height="615" border="1" cellpadding="0" cellspacing="0">
      ...
      <%@include file="adminleftside.jsp" %>
        ...
        <td width="846" height="613" align="right" valign="top" bgcolor="#FFFFFF"><table width="100%" height="612" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td height="612" bgcolor="#FFFFFF">&nbsp;</td>
            </tr>
          </table></td>

        ...
        <td width="846" height="613" align="right" valign="top" bgcolor="#FFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		 ...
		 String groupname=(String)session.getAttribute("groupname");
		  ...
		  <tr>
            ...
            <td width="50%" align="center">Topic : <a href="admintopiccontent.jsp?topicid=<%=stopicid %>"> <%=topicname %></td>
          </tr>
        </table> 
...
<td align="center"><%=comm %></td>
 ...
 <tr><td><a href="adminrecreply.jsp?tmsgid=<%=b2.getTmsgid() %>&topicid=<%=topicid %>">reply(<%=num %>)</a></td></tr>
	...
	<form name="t1" action="adminreplies1.jsp">

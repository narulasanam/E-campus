          ...
          <tr>
            <%@ include file="adminmiddlemenu.jsp" %>
              ...
              <table width="100%" height="591" border="0" cellpadding="0" cellspacing="0">
				...
				<td><a href="admingrouptop.jsp?groupid=<%=b2.getGroupid()%>&groupname=<%=b2.getGroupname() %>">Show Topics</a></td>
				<td align="center"><a href="admingroupdelete.jsp?groupid=<%=b2.getGroupid()%>">Delete</a></td>
